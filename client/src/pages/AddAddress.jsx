...
const AddAddress = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            const { data } = await axios.post('/api/address/add', {
                address,
                userId: user._id, // ✅ Corrected here
            });
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className='text-2xl md:text-3xl text-gray-500'>Add Shipping <span className='font-semibold text-primary'>Address</span>
        </p>
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                    <InputField handleChange={handleChange} address={address} 
                        name='pincode' type="number" placeholder="Pin code"/>
                         <InputField handleChange={handleChange} address={address} 
            ...
            <img className='md:mr-16 mb-16 md:mt-0'src={assets.add_address_iamge} alt="Add Addresss"/>
