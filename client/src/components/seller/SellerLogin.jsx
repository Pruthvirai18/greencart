...
const SellerLogin = () => {
  ...
  return !isSeller && (
    <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-sm text-gray-600'>
        ...
        sm:min-w-80 rounded-lg shadow-xl border border-gray-200'>
            ...
            <div className='w-full'>
                <p>Passowrd</p>
                <input  onChange={(e)=>setPassword(e.target.value)} value={password}className='border border-gray-200 rounded w-full p-2 mt-1 outline-primary required'
